...
<head>
    <title>Code coverage report for src/core/cell/workflows/sys_validation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/core/cell/workflows</a> sys_validation.ts</h1>
        <div class='clearfix'>
...
<a name='L203'></a><a href='#L203'>203</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Cell } from '../../cell';
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function validate_op() {}</span></span>
&nbsp;
export async function sys_validate_element(
  ...
  try {
    ...
    if (!isNotCounterfeit)
<span class="branch-0 cbranch-no" title="branch not covered" >      throw new Error(`Trying to validate counterfeited element`);</span>
  } <span class="branch-0 cbranch-no" title="branch not covered" >catch (e) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(`Trying to validate counterfeited element`);</span>
...
&nbsp;
  ...
  if (maybeDepsMissing) <span class="branch-0 cbranch-no" title="branch not covered" >return maybeDepsMissing;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        depsHashes: [prev_header_hash],</span>
<span class="cstat-no" title="statement not covered" >      };</span>
&nbsp;
...
&nbsp;
  if (header.type === HeaderType.Update) {
    ...
    if (!signed_header) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
<span class="cstat-no" title="statement not covered" >        depsHashes: [header.original_header_address],</span>
<span class="cstat-no" title="statement not covered" >      };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >    throw new Error(`Trying to update a header that didn't create any entry`);</span>
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sun Apr 18 2021 12:43:43 GMT+0200 (Hora d’estiu del Centre d’Europa)
            </div>
        </div>
