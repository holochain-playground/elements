            ...
            htmlPlugin.api.addHtmlTransformer(async (html, { bundle, bundles, htmlFileName }) => {
                ...
                if (utils_1.shouldInjectLoader(config)) {
                    ...
                    const scripts = config
                        .modern.files.map((f) => `<script type="module" src="${f.path}"></script>\n`)
                        .join('');
                ...
                for (const entrypoint of entrypoints) {
                    ...
                    const pathToRoot = path_1.default.posix.relative('./', path_1.default.posix.dirname(entrypoint.importPath));
