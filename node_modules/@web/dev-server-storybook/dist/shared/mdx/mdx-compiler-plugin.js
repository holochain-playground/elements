...
const getMdxSource = children => encodeURI(children
    .map(el => generate(el, {
    quotes: 'double',
}).code)
    .join('\n'));
...
function extractExports(root, options) {
    ...
    const defaultJsx = mdxToJsx.toJSX(root, {}, Object.assign(Object.assign({}, options), { skipExport: true }));
    const fullJsx = [
...
//# sourceMappingURL=mdx-compiler-plugin.js.map