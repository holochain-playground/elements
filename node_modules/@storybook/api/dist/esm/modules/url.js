...
export var init = function init(_ref2) {
  ...
  var initModule = function initModule() {
    ...
    var updateArgsParam = function updateArgsParam(args) {
      ...
      var initialArgs = isStory(currentStory) && currentStory.initialArgs || {};
      var argsString = buildArgsParam(initialArgs, args);
      var argsParam = argsString.length ? "&args=".concat(argsString) : '';
      queryNavigate("".concat(fullAPI.getUrlState().path).concat(argsParam), {
        replace: true
      });
      api.setQueryParams({
        args: argsString
    ...
    fullAPI.on(STORY_ARGS_UPDATED, function (_ref5) {
      ...
      if ('requestIdleCallback' in window) {
        ...
        handleOrId = window.requestIdleCallback(function () {
