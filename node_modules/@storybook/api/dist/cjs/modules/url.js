...
var init = function init(_ref2) {
  ...
  var initModule = function initModule() {
    ...
    var updateArgsParam = function updateArgsParam(args) {
      var currentStory = fullAPI.getCurrentStoryData();
      var initialArgs = (0, _stories.isStory)(currentStory) && currentStory.initialArgs || {};
      var argsString = (0, _router2.buildArgsParam)(initialArgs, args);
      var argsParam = argsString.length ? "&args=".concat(argsString) : '';
      (0, _router2.navigate)("".concat(fullAPI.getUrlState().path).concat(argsParam), {
        replace: true
      });
      api.setQueryParams({
        args: argsString
    ...
    fullAPI.on(_coreEvents.STORY_ARGS_UPDATED, function (_ref5) {
      ...
      if ('requestIdleCallback' in _global.window) {
        ...
        handleOrId = _global.window.requestIdleCallback(function () {
          return updateArgsParam(args);
        }, {
          timeout: 1000
        });
      } else {
