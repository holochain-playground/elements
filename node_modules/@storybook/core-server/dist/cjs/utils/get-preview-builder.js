...
async function getPreviewBuilder(configDir) {
  ...
  var _serverRequire = (0, _coreCommon.serverRequire)((0, _coreCommon.getInterpretedFile)(main)),
      core = _serverRequire.core;

  var builder = (core === null || core === void 0 ? void 0 : core.builder) || 'webpack4';
