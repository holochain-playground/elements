...
var warnImplicitPostcssPlugins = (0, _utilDeprecate.default)(function () {
  ...
  `);
var warnGetPostcssOptions = (0, _utilDeprecate.default)(async function () {
...
async function createDefaultWebpackConfig(storybookBaseConfig, options) {
  ...
  var hasPostcssAddon = options.presetsList.some(function (preset) {
    return /@storybook(\/|\\)addon-postcss/.test(preset.name || preset);
  });
  var cssLoaders = {};
  ...
  if (!hasPostcssAddon) {
    ...
    cssLoaders = {
      test: /\.css$/,
      sideEffects: true,
      use: [// TODO(blaine): Decide if we want to keep style-loader & css-loader in core
