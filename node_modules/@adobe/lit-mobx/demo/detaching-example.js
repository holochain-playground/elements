...
let DetachingExample = class DetachingExample extends MobxLitElement {
    constructor() {
        super(...arguments);
        this.counter = new Counter();
        this.connectChild = false;
    }
    render() {
        return html `
...
], DetachingExample.prototype, "connectChild", void 0);
DetachingExample = __decorate([
    customElement('detaching-example')
], DetachingExample);
export { DetachingExample };
//# sourceMappingURL=detaching-example.js.map