...
declare const PlaygroundElement_base: typeof LitElement & import("@open-wc/dedupe-mixin").Constructor<import("@open-wc/scoped-elements/types/src/types").ScopedElementsHost> & typeof import("@open-wc/scoped-elements/types/src/types").ScopedElementsHost & import("lit-element").Constructor<import("@holochain-playground/container").PlaygroundElement>;
